...
@Tag(
        name = "CRUD REST APIs for Accounts in WorldBank",
        description = "CRUD REST APIs in WorldBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside WorldBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
